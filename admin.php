...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `products` SET name = '$update_product_name', price = '$update_product_price', image = '$update_product_image' WHERE id = '$update_product_id'");
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="submit" value="A dd the product" name="add_product" class="btn">
</form>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" required name="update_product_name" value="<?php echo $fetch_edit['name']; ?>">
      <input type="number" min="0" class="box" required name="update_product_price" value="<?php echo $fetch_edit['price']; ?>">
